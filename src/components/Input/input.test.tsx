...
describe("test Input component", () => {
  it("should render the correct default Input", () => {
    ...
    expect(testNode).toHaveClass("normalized-input-inner");
  ...
  it("should render prepend and append element on prepend/append property", () => {
    ...
    const testContainer = container.querySelector(".normalized-input-wrapper");
    expect(testContainer).toHaveClass(
      "input-group input-group--append input-group--prepend input-group--append"
    );
